...
export function gradeStudent(student, correctAns) {
...
export function gradeQuiz(studentsArray, correctAns) {
    let result = [];
...
student2;
student3;
export function gradeQuizLabeled(quizArray, correctAnswer) {
    let result = [];
