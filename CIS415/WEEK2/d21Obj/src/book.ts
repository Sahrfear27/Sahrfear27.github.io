...
//     let libraryBooks = [title, author, libraryID];
...
//     // document.body.prepend(bookTitle);
//     // bookTitleInput.value = title;
//     // bookTitle.after(bookTitleInput);
...
//     // // Create input for the book
//     // let bookInput = document.createElement('input');
//     // bookInput.value = author;
//     // bookAuthor.after(bookInput);

//     // // Create an libraryId for the input

//     // let libraryCard = document.createElement('label');
//     // libraryCard.innerHTML = "libraryID";
//     // document.body.append(libraryCard);

//     // // Create an input for the library card
//     // let libraryInput = document.createElement('input');
//     // libraryInput.value = libraryID;

//     // let createBook = [];
//     // createBook.push(title);
//     // createBook.push(author);
//     // createBook.push(libraryCard);
