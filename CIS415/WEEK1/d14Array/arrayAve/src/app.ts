...
// Put the student in the array
let arrayAnswers = [student1, student2, student3];
console.log(arrayAnswers);

// Function to cumpute the score 
// Student is of type object
function computeScore(stud: student, quizKey: number[]): number {

    // Get the student answers
    const answers = stud.quizAnswers;

    let correctNum = 0; //Set the correctNum to 0;
...
console.log("Expect 3: ", computeScore(student1, [3, 1, 2, 4]));




// Create an object of an employee and delcare the type of the object
