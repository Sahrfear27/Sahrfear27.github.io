...
import { calculateDailyTotalDuration, getAllSessions, getAllSessionsForUser,getAllDurations
} from "../src/exam.js";
// import { type } from "os";
...
describe("fitness tracking", function () {
    ...
    it("calculateDailyTotalDuration", function () {
        assert.strictEqual(calculateDailyTotalDuration([day2]), 120)
    });
    ...
    it("calculateTotalDuration", function () {
        assert.deepEqual(calculateDailyTotalDuration(dailyRecord), 225);
    });
